...
<html>
    <head>
        ...
        <script>
            function validateForm() {
                ...
                var aircraftname = document.forms["flightForm"]["aircraftname"].value;
                ...
                if (aircraftname == null || aircraftname == "") {
    ...
    <body>
        ...
        <form name="flightForm" action ="AddFlightDB" onsubmit="return validateForm();">
            <table>
                <tr>
                ...
                <tr>
                    <td align ="right">Aircraft</td><td><input type ="text" name ="aircraftname"></td>
                </tr> 
                <tr>
