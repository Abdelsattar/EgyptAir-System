...
<html>
    ...
    <body>
        <%
            ...
            String aircraftname = (String) request.getSession().getAttribute("SelectedflightsAircraftname");
        ...
        <form action="updateFlight">
            <table>
                ...
                <tr>
                    <td align ="right">Day</td> <td><input type="text" name ="day"value=<%=fdate.getDay()%>></td>
                </tr>
                <tr>
                    <td align ="right">Month</td> <td><input type="text" name ="month"value=<%=fdate.getMonth()%>></td>
                </tr>
                <tr>
                    <td align ="right">Year</td> <td><input type="text" name ="year" value =<%=fdate.getYear()%>></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align ="right">Aircraft</td><td><input type ="text" name ="aircraftname"value=<%=aircraftname%>></td>
                </tr>
            </table>
        </form>
    </body>
