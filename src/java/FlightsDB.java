...
public class FlightsDB extends HttpServlet {
    ...
    ArrayList<String> aircraftnames;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!flightIDs.isEmpty()) {
            ...
            session.setAttribute("flightsAircraftNames", aircraftnames);
    ...
    void getFlightsDB() {
        ...
        try {
            ...
            for (int i = 0; i < aircraftIDs.size(); i++) {
                RS = Stmt.executeQuery("SELECT * FROM egyptair.aircraft where aircraftID ='" + aircraftIDs.get(i) + "';");
                while (RS.next()) {
                    aircraftname = RS.getString("name");
